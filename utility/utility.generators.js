 ...
 * @returns Returns a semi-randomly generated number-only string using numbers between 0 and 9
 */
 ...
 * @returns Returns a string if the `dateToCheck` is below 10 then the string starts with a 0 if not the `dateToCheck` is returned.
 */
 ...
 * @returns Returns a date string with the format ddmmyy
 */
